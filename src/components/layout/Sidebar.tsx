...
function UgandaFlag({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M14.4 14.1 Q15.6 12.2 14 10.9"
        stroke="#555"
        strokeWidth="1.2"
        fill="none"
        strokeLinecap="round"
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/app/rtgs/interbank",
        icon: ArrowLeftRight,
        label: "Interbank Transfers",
      },
      { path: "/app/rtgs/treasury", icon: Vault, label: "Treasury Transfers" },
      {
        path: "/app/rtgs/participants",
        icon: UserCheck,
        label: "RTGS Participants",
      },
      {
        path: "/app/rtgs/exceptions",
        icon: AlertTriangle,
        label: "RTGS Exceptions",
      },
      ...
      >
            ...
            {!collapsed && (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-accent text-[10px] truncate">
        ...
        <div className="border-t border-primary-light/30 px-3 py-3 space-y-2">
          ...
          {collapsed && (
            <button
              onClick={logout}
              className="w-full flex justify-center text-white/40 hover:text-red-400 transition-colors"
              aria-label="Logout"
            >
              <LogOut size={14} />
            </button>
