// src/routes/app/agency/reports.tsx
...
const REPORTS = [
  { id: 'daily-collections',  title: 'Daily Collections Report',    description: 'All payments received today — by service, channel, and status', period: 'Daily' },
  { id: 'settlement-summary', title: 'Settlement Summary',          description: 'Settlement batches — gross, net, fees, SLA compliance',          period: 'Daily' },
  ...
  { id: 'service-breakdown',  title: 'Service Revenue Breakdown',   description: 'Collection volumes and revenue per service type',                 period: 'Monthly' },
  { id: 'channel-analysis',   title: 'Channel Analysis',            description: 'Transaction volumes and success rates by payment channel',        period: 'Monthly' },
  { id: 'reversals',          title: 'Reversals & Refunds Report',  description: 'Failed payments, reversals, and refund statuses',                 period: 'Monthly' },
]
  ...
  return (
    <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-4">
      <motion.div variants={fadeInUp}>
        <PageHeader title="Reports" subtitle={`${tenantName} — downloadable collection and settlement reports`} />
      </motion.div>
