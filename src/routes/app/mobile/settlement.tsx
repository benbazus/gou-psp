// src/routes/app/mobile/settlement.tsx
...
const STATUS_CLS: Record<MobileSettlement['status'], string> = {
...
const SLA_CLS: Record<MobileSettlement['slaStatus'], string> = {
  compliant: 'text-green-600',
  warning:   'text-amber-600',
  breach:    'text-red-600',
}

export default function MobileSettlementPage() {
  ...
  return (
    <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-4">
      <motion.div variants={fadeInUp}>
        <PageHeader
          title="Settlement"
          subtitle="Daily mobile money settlement batches"
          actions={
